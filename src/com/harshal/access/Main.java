...
2.  public --> we can access anything directly which is declared as public.
    we declare name as public and call it in another package. here, encapsulation. we always have to import the package for
...
3.  protected --> We can access anything which declared as protected in same class, same package, subclass of that superclass
    and subclass of that superclass in different package like we do with int n variable in demo package inside class name
    subclass.
